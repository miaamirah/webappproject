            ...
            <div class="row row-deck row-cards">
                  ...
                  <div class="card">
                      <div class="card-body">
                          <div class="d-flex align-items-center">
                              <div class="subheader">Academicians</div>
                          ...
                          <div class="d-flex mb-2">
                              ...
                              <div class="ms-auto">
                                  <span class="text-green d-inline-flex align-items-center lh-1">
                                      <!-- Placeholder for any percentage or metric -->
                                      {{ $academiciansCount }} <!-- Example usage -->
                                  </span>
                              </div>
                          </div>
                          <div class="progress progress-sm">
                              <div class="progress-bar bg-primary" style="width: {{ $academiciansCount }}%" role="progressbar" aria-valuenow="{{ $academiciansCount }}" aria-valuemin="0" aria-valuemax="100" aria-label="Progress">
                                  <span class="visually-hidden">{{ $academiciansCount }}% Complete</span>
                              </div>
                          </div>
                      </div>
                  </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="subheader">Grants</div>
                            <div class="ms-auto lh-1">
                                <!--div class="dropdown">
                                    <a class="dropdown-toggle text-secondary" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="d-flex align-items-baseline">
                            <div class="h1 mb-0 me-2">{{ $grantsCount }}</div>
                            <div class="me-auto">
                                <span class="text-green d-inline-flex align-items-center lh-1">
                                    <!-- Placeholder for metric -->
                                    {{ $grantsCount }} <!-- Example usage -->
              ...
              <div class="col-sm-6 col-lg-3">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <div class="d-flex align-items-baseline">
                              <div class="h1 mb-3 me-2">{{ $milestonesCount }}</div>
                              <div class="me-auto">
                                  <span class="text-green d-inline-flex align-items-center lh-1">
                                      4% <!-- Placeholder for growth percentage -->
                                      <svg xmlns="http://www.w3.org/2000/svg" class="icon ms-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                          <path d="M3 17l6 -6l4 4l8 -8" />
                                          <path d="M14 7l7 0l0 7" />
